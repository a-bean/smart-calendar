...
const getDateScope = (scope: [string, string]) => {
  ...
  data.value = {
    '2024-03-07': [
      { id: 13, name: '库里', start: '2024-03-07 03:00', end: '2024-03-07 07:00', color: 'purple' },
      { id: 14, name: '格林', start: '2024-03-07 08:00', end: '2024-03-07 12:00' },
      { id: 15, name: '汤普森', start: '2024-03-07 05:00', end: '2024-03-07 13:00' },
    ],
  };
};
